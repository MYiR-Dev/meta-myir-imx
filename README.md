...
The repository https://github.com/nxp-imx/meta-myir contains multiple Yocto Project layers supporting
Linux development for the NXP i.MX Series 6 through 9.

| Layer            | Purpose               |
|------------------|-----------------------|
| meta-myir-bsp     | BSP                   |
| meta-myir-cockpit | eCockpit              |
| meta-myir-ml      | Machine Learning      |
| meta-myir-sdk     | Distro                |
| meta-myir-v2x     | Vehicle-to-Everything |
