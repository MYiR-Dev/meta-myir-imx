...
if [ -f ${mfg_path}/myd-y6ull-14x14-nand-512d-Manifest ]
then
    . ${mfg_path}/myd-y6ull-14x14-nand-512d-Manifest
else
    echo "Can not find file ${mfg_path}/myd-y6ull-14x14-nand-512d-Manifest"
	update_fail "no_loop"
    exit 1
fi
