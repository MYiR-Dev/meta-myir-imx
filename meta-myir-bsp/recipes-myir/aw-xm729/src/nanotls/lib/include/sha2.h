 ...
 */
extern void cf_sha256_init(void *ctx);

/* .. c:function:: $DECL
 * Hashes `nbytes` at `data`.  Copies the data if there isn't enough to make
 * a full block.
 */
extern void cf_sha256_update(void *ctx, const void *data, size_t nbytes);
 ...
 */
extern void cf_sha256_digest(void *ctx, uint8_t hash[CF_SHA256_HASHSZ]);
 ...
 */
extern void cf_sha224_init(void *ctx);

/* .. c:function:: $DECL
 * Hashes `nbytes` at `data`.  Copies the data if there isn't enough to make
 * a full block.
 */
extern void cf_sha224_update(void *ctx, const void *data, size_t nbytes);
 ...
 * This leaves `ctx` unchanged.
 */
extern void cf_sha224_digest(void *ctx, uint8_t hash[CF_SHA224_HASHSZ]);
 ...
 */
extern void cf_sha224_digest_final(void *ctx, uint8_t hash[CF_SHA224_HASHSZ]);
